...
exports.getTestPickupResponse = exports.getTestPickupRequest = void 0;
function getTestPickupRequest() {
    return {
        pickUpShipment: {
...
exports.getTestPickupRequest = getTestPickupRequest;
function getTestPickupResponse() {
    return {
        pickUpResponse: {
            notification: [
                {
...
exports.getTestPickupResponse = getTestPickupResponse;
