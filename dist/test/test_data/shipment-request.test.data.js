...
exports.getTestShipmentResponse = exports.getTestShipmentRequest = void 0;
function getTestShipmentRequest() {
    return {
        requestedShipment: {
            shipmentInfo: {
...
exports.getTestShipmentRequest = getTestShipmentRequest;
function getTestShipmentResponse() {
    return {
        shipmentResponse: {
            notification: [
                {
...
exports.getTestShipmentResponse = getTestShipmentResponse;
